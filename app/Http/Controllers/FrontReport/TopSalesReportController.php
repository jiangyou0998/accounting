...
class TopSalesReportController extends Controller
{
    ...
    public function report(Request $request){
        ...
        $catsAndGroups = KBWorkshopGroup::getGroups();

        $products = KBWorkshopCartItem::getItemsByDateRange($start_date, $end_date, $shop_ids, $group_ids, $limit);
...
//        dump($shops);
        ...
        return view('front_reports.top_sales.report', compact('products', 'shops', 'productInfosArr', 'unitInfoArr', 'catsAndGroups'));
