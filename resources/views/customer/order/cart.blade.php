...
<div class="container-fluid">
    ...
    <div class="row main-div">
        <div class="col-6 left-div">
            ...
            @include('customer.order.cart_item')

        </div>
        <div class="col-6 right-div" style="background-color:#697caf;">
            <div> @include('customer.order.cart_cat')</div>
            <br>
{{--                        <div class="container-fluid"> @include('customer.order.cart_group')</div>--}}
            <div class="container-fluid group-nav"> </div>
            <hr>
            {{--            <div> @include('customer.order.cart_menu')</div>--}}
...
<script>
    ...
    function showGroup(catid) {
        ...
        $.ajax({
            type: "POST",
            url: "/customer/order/cart/show_group/"+catid+'?shop_id={{request()->shop}}',
            data: "",
            dataType:'html',
            // headers: {
            //     'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    function showProduct(groupid) {
        ...
        $.ajax({
            type: "POST",
            url: "/customer/order/cart/show_product/"+groupid+'?shop_id={{request()->shop}}',
    ...
    function sss() {
        ...
        $.ajax({
            type: "PUT",
            url: "{{route('customer.cart.update', request()->shop)}}",
            data: {
