...
{{--    <div align="left">--}}
{{--        <a target="_top" href="javascript:window.opener=null;window.close();" style="font-size: xx-large;">關閉</a>--}}
{{--    </div>--}}
...
{{--                <a class="btn btn-success btn-lg" href="javascript:window.opener=null;window.close();" role="button">關閉</a>--}}
                <div align="right">
                    <strong>
