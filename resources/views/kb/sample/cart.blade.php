...
<div class="container-fluid">
    ...
    <div class="row main-div">
        <div class="col-6 left-div">
            ...
            @include('kb.sample.cart_item')

        </div>
        <div class="col-6 right-div" style="background-color:#697caf;">
            <div> @include('kb.sample.cart_cat')</div>
            <br>
{{--                        <div class="container-fluid"> @include('kb.sample.cart_group')</div>--}}
            <div class="container-fluid group-nav"> </div>
            <hr>
            {{--            <div> @include('kb.sample.cart_menu')</div>--}}
...
<script>
    ...
    function showGroup(catid) {
        ...
        $.ajax({
            type: "POST",
            url: "/kb/sample/show_group/"+catid,
            data: "",
            dataType:'html',
            // headers: {
            //     'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    function showProduct(groupid) {
        // alert("order/cart/show_group/"+catid);
        var deli_date = '9999-12-31';
        console.log(deli_date);
        $.ajax({
            type: "POST",
            url: "/kb/sample/show_product/"+groupid,
        ...
        $.ajax({
            ...
            success: function (msg) {
                ...
                Swal.fire({
                    ...
                    if (result.isDenied) {
                        window.location.href = '{{route('kb.sample')}}';
                    } else {
                        window.location.reload();
                    }
