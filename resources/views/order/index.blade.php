...
<div align="center" style="width:100%;" class="row">
    <div class="col-sm-6">
        ...
        <br/>
        <a href='check_order_number.php' class='styleA' target='view_window'>翻查已下單數目</a><br/><a href='select_day_by_time.php' class='styleA'>改舊單</a><br/><a href='select_deli_by_shop.php' class='styleA'>送貨單查詢</a>
    </div>
    <div class="col-sm-6">
