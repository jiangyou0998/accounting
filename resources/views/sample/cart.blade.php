...
<div class="container-fluid">
    ...
    <div class="row main-div">
        <div class="col-6 left-div">
            ...
            @include('sample.cart_item')

        </div>
        <div class="col-6 right-div" style="background-color:#697caf;">
            <div> @include('sample.cart_cat')</div>
            <br>
{{--                        <div class="container-fluid"> @include('sample.cart_group')</div>--}}
            <div class="container-fluid group-nav"> </div>
            <hr>
            {{--            <div> @include('sample.cart_menu')</div>--}}
...
<script>
    ...
    function sss() {
        ...
        @if($sample->id)
            ...
            type = 'PUT';
        @else
            url = '{!! route('sample.store',['dept'=> Request()->dept , 'shopid'=>request()->input('shopid')]) !!}';
            type = 'POST';
        @endif
