...
<!-- 表單開始 -->
<form class="layui-form" action="{{route('itsupport.update',$itsupport->id)}}" method="POST">
        {{ method_field('PATCH') }}
        {{ csrf_field() }}
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea name="comment" placeholder="请输入内容" class="layui-textarea">{{$itsupport->comment}}</textarea>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline"> <!-- 注意：这一层元素并不是必须的 -->
            <input readonly type="text" class="layui-input" id="cDate" name="cDate" autocomplete="off" value="{{$itsupport->complete_date}}">
        </div>
    </div>
